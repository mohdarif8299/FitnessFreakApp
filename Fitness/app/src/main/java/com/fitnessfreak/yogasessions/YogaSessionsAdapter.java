...
public class YogaSessionsAdapter extends RecyclerView.Adapter<YogaSessionsAdapter.ViewHolder> {
    List<YogaSessionsModel> featuredProgramList;
    Context context;

    public YogaSessionsAdapter(List<YogaSessionsModel> featuredProgramList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.single_yoga_sessions, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        YogaSessionsModel featuredProgram = featuredProgramList.get(position);
        ...
        holder.linearLayout.setOnClickListener(v -> {
            Intent intent = new Intent(context, YogaSessions.class);
            Gson gson = new Gson();
